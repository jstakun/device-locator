...
public class DlFirebaseInstanceIdService extends FirebaseInstanceIdService {
    ...
    public static void sendRegistrationToServer(Context context, final String token, final String pin) {
        try {
            ...
            if (StringUtils.isNotEmpty(pin)) {
                ...
                Network.post(url, content, null, headers, new Network.OnGetFinishListener() {
                    @Override
