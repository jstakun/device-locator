                    ...
                    try {
                        ...
                        if (location != null) {
                            if (phoneNumber != null && phoneNumber.length() > 0) {
                                com.gmsworld.devicelocator.Utilities.Messenger.sendLocationMessage(RouteTrackingService.this, location, true, 0, phoneNumber);
                                com.gmsworld.devicelocator.Utilities.Messenger.sendGoogleMapsMessage(RouteTrackingService.this, location, phoneNumber);
                            }
                            String message = "New location: " + location.getLatitude() + "," + location.getLongitude() +
                                             ...
                                             "\nBattery level: " + com.gmsworld.devicelocator.Utilities.Messenger.getBatteryLevel(RouteTrackingService.this) + "%";
                            //Log.d(TAG, message);
                            if (email != null && email.length() > 0) {
                                ...
                                com.gmsworld.devicelocator.Utilities.Messenger.sendEmail(RouteTrackingService.this, email, message, title);
                            }
                            if (telegramId != null && telegramId.length() > 0) {
                                com.gmsworld.devicelocator.Utilities.Messenger.sendTelegram(RouteTrackingService.this, telegramId, message);
                            }
